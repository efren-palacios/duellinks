...
function obtainCardInformation( instance, current ) {
    ...
    let cardinfo = axios.get("https://corsproxy.our.buildo.io/https://yugiohprices.com/api/card_data/" + cardName).then(function(r) {
        return r.data
    });
...
function obtainTextForDesktops( event, api ) {
    ...
    if(type == "cardPopup") {
        ...
        let cardinfo = axios.get("https://corsproxy.our.buildo.io/https://yugiohprices.com/api/card_data/" + name).then(function(r) {
            return r.data
        });
        Promise.all([cardobtain, cardinfo]).then(function(r) {
