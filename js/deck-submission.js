...
function setDiscordAuthURL() {
    ...
    $('#discord-login-button').attr('href', 'https://discordapp.com/api/oauth2/authorize?client_id=446020809153183744&redirect_uri=' + encodeURIComponent(websiteLink) + '%2Fsubmit-your-deck%2F&response_type=token&scope=identify');
}