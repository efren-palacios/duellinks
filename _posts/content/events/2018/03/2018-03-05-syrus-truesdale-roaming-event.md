...
**Strategy**
- Use {Magical Mallet} to get a copy of {A Legendary Ocean} and {Spirit Barrier} in your hand as fast as possible
- Use the Reinforcements skill to get {The Legendary Fisherman} into your hand
- Once you have these 3 cards on the field, you're safe from everything

**Last Turn** 
- Use {Polymerization} to Fusion Summon {Twin-Headed Thunder Dragon}
- Summon {Gravekeeper's Vassal} and target him with your {Union Attack} and {Secret Pass to the Treasures}
- Enter Battle Phase, use {Anti-Magic Arrows}, and swing for victory

**Replacements**
- {Crystal Seer} can be swapped out for basically any card that helps you draw, such as {Skelengel}

**Risks**
- Again, if you don't open well and can't fish out your combo pieces then it's game over
- This is one of the least consistent farm decks, but requires much less interaction than the others
