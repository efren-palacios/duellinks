...
<div class="section">
    <img src="/img/discord_logo_wordmark.png" class="mx-auto d-block">
    <div class="section text-center">
        <ul class="list-unstyled" id="feature-list">
            <li>Advanced Tips</li>
            <li>Priority Advice</li>
            <li>Previews of future decks/content</li>
            <li>Text/Voice chat with a competitve community</li>       
        </ul>    
    </div>
</div>
