...
CA has the resource replacement of Gravekeeper’s and the resource recycling of Lotus Harpies. The problem with most ritual decks is that they struggle attaining the necessary levels to bring out their monsters, resulting in relinquished being the only viable ritual build because of the low summoning cost and synergy with SK. CA solves this problem by searching out new material when you spend what you have.

---
### Adressing Nerfs

#### How Will The Nerfs Affect CA?

If you thought CA was tier 0 before, you probably think it will be tier 1 or tier 2 now. If you thought CA was only tier 1 before, you may think that they will be tier 2 or even tier 3. Let me make this clear in no uncertain terms. **CA is still top tier in the current meta. Just because you can’t mindlessly win with the deck anymore doesn’t mean it’s trash.** The nerfs to both MAR and {Balance} are serious concerns, however I understand the necessity to do so. What was once a tier 0 deck is not tier 0 anymore but is still good enough to be tier 1, especially if REZ (CA’s main contender) will also be getting nerfs.

#### How Will Nerfs/New Boxes Affect This Guide?

Changes to the game and the evolution of the meta will result in areas becoming obsolete, and while I sometimes wish it were true, I can’t spend 100% of my time updating this guide every time konami has a new card flipper campaign. I continuously try to keep this guide as up to date as I can regarding new information, cards, and strategies. If I haven’t covered something new, just give me a day or two and I will most likely cover it in some way or another.
...
In the current meta, CA has a variety of viable skills available I will try to list the top 4 (in no particular order) and give reasoning as to why you should pick a certain skill over another.

#### **Restart:**
{Restart} is an all around safe choice for CA. It’s versatile because you can tech in cards and restart your hand if you think you will need specific techs for a given matchup. I personally used Restart CA for days 2 and 3 of the KC Cup, and I wouldn’t be surprised if many of the top 100 did the same.

![](https://image.prntscr.com/image/CEUjDX-yTb6pAsLL7cH20w.png)
...
by: pll
[Balance decklist](http://prntscr.com/hm8h0f)
...
[Duel Standby decklist](http://prntscr.com/hm8gaa)
...
[Mind Scan decklist](http://prntscr.com/hm8fv6)
...
[Restart decklist](http://prntscr.com/hm3isz) | [Balance decklist](http://prntscr.com/hm3j7e)
...
![Dakini](http://prntscr.com/hm9orp) | ![Idaten](http://prntscr.com/hm9olp) | ![Benten](http://prntscr.com/hm9og3)
...
![Sonic Bird](http://prntscr.com/hm8dtm) | ![Senju of the Thousand Hands](http://prntscr.com/hm8e1x) | ![Cyber Petit Angel](http://prntscr.com/hm8f2b)
...
![Machine Angel Ritual](http://prntscr.com/hm8d0s) | ![Machine Angel Absolute Ritual](http://prntscr.com/hm8db7) | ![Sprite's Blessing](http://prntscr.com/hm8dm7)
...
![CA Core](http://prntscr.com/hm8ipk)

**Ritual Spells:**
**Aim to have 6 ritual spells.** Running 5 is also viable, but straying too far will lead to consistency issues. Don’t forget that {Sonic Bird} can be treated as a ritual spell as it can search for one when summoned.
Ritual Spells  highlighted in green.
...
![Spell/Trap-based techs](http://prntscr.com/hm9hpc)![Monster-based techs](http://prntscr.com/hm9huq)

---

### Combos

   The nerfs have hit some combos harder than others, but most are still possible. The nerfs have limited the use of combos to only allow for 1 MAR, and combos that rely on MAR being in the hand or in the Graveyard are far less applicable.

##### **Idaten + Benten**
**Don’t always go for this combo.** Tribute Benten for Idaten to search for a fairy and a ritual spell. When using your search for a fairy, **don’t tunnel vision on Dakini.** Quite often you will find Petit or Senju will do a better job; they serve a similar function to searching Dakini with Benten, but taking the extra step thins the deck and gives you more levels to work with, leading to more consistent results. Even if you can’t summon Petit/Senju the turn you search for them, giving yourself combo potential on future turns is more valuable than starting with a “winning” board.

##### **Benten Looping**
If you have a plethora of ritual spells at your disposal, then consider this simple combo. Tribute a Benten to summon Benten. With your fairy search, get a third Benten. Tribute the one on the field for the one you just searched. What did this accomplish? To the untrained eye, this was a waste of ritual spells, but if you give it some thought, you would realize that you are thinning your deck, resulting in a more predictable draw. Since you used most of your Benten’s and ritual spells, you will increase your chances of drawing into a searcher. This combo also leads into the Idaten Benten combo.
...
##### **Double Benten Tribute**
It is generally a good idea to not waste levels when ritual summoning, however this rule should not be held 100% of the time.
Suppose this example going second:

Hand: 1 Dakini, 2 Benten, 1 MAR, 1 MAAR

| Tribute Benten for Benten                                                                                        | Tribute Both Benten for Dakini                                                                                                                  |
|------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| 1. Activate MAR and tribute Benten to sumnon Benten                                                              | 1. Activate MAR and tribute both Benten to summon Dakini                                                                                        |
| 2. Benten search for Idaten                                                                                      | 2. Benten search Petit and Idaten                                                                                                               |
| 3. Activate MAAR and tribute Benten for Idaten                                                                   | 3. Summon Petit and Petit search Benten                                                                                                         |
| 4. Benten search Petit, Idaten search MAAR                                                                       | 4. Activate MAR and tribute Benten for Idaten                                                                                                   |
| 5. Summon Petit and Petit search Benten                                                                          | 5. Benten search Dakini, Idaten search MAAR                                                                                                     |
| 6. Activate MAAR and tribute Benten and Petit for Dakini                                                         | 6. Activate MAAR and tribute Petit on the field and return a Benten to the deck to summon Dakini                                                |
| 7. Benten search to set up for next turn (Petit most likely)                                                     | 7. End phase return Benten and MAR to hand                                                                                                      |
| 8. End phase return Benten to hand                                                                               |                                                                                                                                                 |
|                                                                                                                  |                                                                                                                                                 |
| Hand: 1 Benten, 1 Petit                                                                                          | Hand: 1 Benten, 1 MAR                                                                                                                           |
| Field: 1 Dakini, 1 Idaten                                                                                        | Field 2 Dakini, 1 Idaten                                                                                                                        |
| Deck: 10 cards                                                                                                   | Deck: 11 cards                                                                                                                                  |
|                                                                                                                  |                                                                                                                                                 |
| **Pros:**                                                                                                            | **Pros:**                                                                                                                                           |
| sets up more for the next turn; an Petit and Benten in the hand is spectacular combo food for CA.                | Better against only 1 backrow; your opponent MUST have multiple answers to deal with both Dakinis otherwise you stomp them out.                 |
| Works with MAR or MAAR, so it can be applied in more situations.                                                 | Higher OTK potential due to increase field presence.                                                                                            |
| Doesn’t return any cards to the deck, giving your Dakini more cards to return.                                   | Sets up for tribute Idaten for Benten, buffing your whole board, and leading to an almost guaranteed win (against an aggressive deck at least). |
|                                                                                                                  |                                                                                                                                                 |
| **Cons:**                                                                                                            | **Cons:**                                                                                                                                           |
| Loses much harder to econ overall; if you activate Dakini’s effect, an econ take will wipe out your only Dakini. | Doesn’t leave much room for defense.                                                                                                            |
| Floodgate can prevent your lone Dakini from remaining face up, leading to less material in hand.                 | You are returning resources to the deck, leaving you less monsters to return with Dakini.                                                       |
