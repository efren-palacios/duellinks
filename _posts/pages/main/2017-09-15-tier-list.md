...
<div class="section header">
    <h4>Updated weekly by the best players in the game, the <a href="/top-player-council/">Top Player Council</a>.</h4>
</div>
...
<div class="section">
    <a href="/tier-list/forbidden-limited-list/"><h5>Forbidden/Limited List Changes: {{ forbiddenDate | date: "%B %d, %Y" }}</h5></a>
</div>
